...
PYBIND11_MODULE(drawmate, m)
{
    ...
    py::class_<LabelExport>(m, "Label")
        ...
        .def_readonly("source_id", &LabelExport::source_id)
        .def_readonly("target_id", &LabelExport::target_id)
    ...
    py::class_<LinkExport>(m, "Link")
        ...
        .def_readonly("_id", &LinkExport::_id)
        .def_readonly("source_id", &LinkExport::source_id)
        .def_readonly("target_id", &LinkExport::target_id)
    ...
    py::class_<PortExport>(m, "Port")
        ...
        .def_readonly("source_id", &PortExport::source_id)
        .def_readonly("target_id", &PortExport::target_id);
    
    py::class_<NodeExport>(m, "Node")
        .def(py::init<>())
        .def_readonly("name", &NodeExport::name)
        .def_readonly("source_id", &NodeExport::source_id)
        .def_readonly("target_id", &NodeExport::target_id)
