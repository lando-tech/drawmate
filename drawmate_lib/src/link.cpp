...
void Link::set_source_port(const int source_port_id, const double source_x, const double source_y)
{
...
void Link::set_target_port(const int target_port_id, const double target_x, const double target_y)
{
...
void Link::add_link(const int source_port_id, const int target_port_id, const double source_x, const double source_y,
